...
var groupGrid = {
	    ...
	    loadGrid: function(){
			$("#fitGroupTable").jqGrid({
				...
				colModel: [
					{label:'团号',name: 'groupCode',index: 'groupCode',width: 100, sortable: false, align:'left'},
					{label:'类型',name: 'groupMode',index: 'groupMode',width: 50, sortable: false, align:'center',
					...
					{label:'日期',name: 'dateStart',index: 'date_start',align: "center", sortable: true,formatter:function(cellValue,options,rowObject){
						return (moment(rowObject.dateStart).format("MM-DD")+"/"+moment(rowObject.dateEnd).format("MM-DD"));},width: 50, align:'center'},
					{label:'产品名称',name: 'productName',index: 'productName',width: 300, sortable: false, align:'left',
	                    formatter:function(cellValue,options,rowObject){
	                        return ("【"+rowObject.productBrandName+"】"+cellValue);
	                    }
	                },
					{label:'导游',name: 'guideName',index: 'guideName',width: 60, sortable: false, align:'center'},
					{label:'订单数',name: 'orderNum',index: 'order_num',width: 60, sortable: true,align:'center'},
					{label:'成人',name: 'totalAdult',index: 'total_adult',width: 60, sortable: true, align:'center'},
					{label:'儿童',name: 'totalChild',index: 'total_child',width: 60, sortable: true, align:'center'},
					{label:'计调',name: 'operatorName',index: 'operatorName',width: 60, sortable: false, align:'center'},
					{label:'团状态',name: 'groupState',index: 'groupState',width: 60, sortable: false, align:'center',
						 formatter:groupGrid.formatGroupState},
					{label:'操作',name: 'operations',index: 'operations',width: 60, sortable: false,align:'center',cellattr: addCellAttr,
