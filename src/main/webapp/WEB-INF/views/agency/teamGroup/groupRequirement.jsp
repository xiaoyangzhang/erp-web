...
<script type="text/javascript">
	function toRequirement() {
			window.location = "../agencyTeam/toRequirement.htm?orderId=${orderId}&operType=${operType}&isSales=${reqpm.isSales}";
	}

	function toTeamGroupInfo() {
			window.location = "../agencyTeam/toEditTeamGroupInfo.htm?groupId=${groupId}&operType=${operType}&isSales=${reqpm.isSales}";
	}
	$(function(){
