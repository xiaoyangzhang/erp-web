...
//					data = eval(data);
//					var s = "<option value=''>请选择省</option>";
...
function chkSupplier(obj,id,name,type,typename,province,city,area,town){
	if($(obj).is(':checked')){
...
<body>	
	<div class="p_container" >		
		<div id="divCenter" class="component_div" >
			...
			<div id="supplierDiv">
				<jsp:include page="supplier-list-table-single.jsp"></jsp:include>					
			</div>
		</div>
