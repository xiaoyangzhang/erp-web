...
<body>
	<dl class="p_paragraph_content">
		<form id="saveResProductForm" style="text-align: center;">
			<input type="hidden" name="id" value="${id }" id="order_id" />
			<dd class="inl-bl">
				...
				<div class="clear"></div>
				<div class="dd_right" id="textarea_id">
					<label><textarea class="l_textarea_mark" name="remark" rows="10" cols="50"
...
<script type="text/javascript">
	function cancelOrderOK(){
		...
		$.ajax({
			type : "post",
			url : "<%=path%>/resOrder/toUpdateProductPrice.do",
