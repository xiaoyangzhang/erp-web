			...
			<div class="searchRow">
				...
				<ul> -->
					...
					<li>
						...
						<a href="javascript:void(0)"  onclick="toPreviewStatement()"  class="button button-primary button-small" >
						打印预览</a>
					</li>
				</ul>
			</div>
...
function queryList(page,pagesize) {	
    ...
    var options = {
		url:"<%=staticPath%>/finance/settleListPage.htm",
    	type:"post",
    	dataType:"html",
...
function toPreviewStatement(){
	window.open("<%=ctx%>/finance/statementCheckPreview.htm?start_min="+
			...
			+"&sl="+$("input[name='sl']").val()+"&audit_user="+$("#audit_user").val()
			);
}
</script>
</html>