...
<body>
    ...
    <form id="queryForm">
	    	...
	    	<dl class="p_paragraph_content">
	    		...
	    		<dd class="inl-bl">
	    			<div class="dd_left">车队/车牌号：</div>
	    			<div class="dd_right">
						<input type="text" name="carInfo" id="carInfo" value=""/> 
...
function queryList(page,pagesize) {	
    ...
    var options = {
   		url:"<%=path%>/finance/queryShopCommissionDeductionStats2.do",
    	type:"post",
    	dataType:"html",
...
function postShopAudit(ckbox) {
	...
	YM.post("<%=staticPath%>/finance/auditComm.do", pm, function(data) {
		$.success('操作成功');
		queryList();
	});
}
