...
//queryList();
		...
		function queryList(page, pagesize) {
			...
			var options = {
				url: "<%=staticPath %>/finance/incomeJoinTableList.do",
				type: "post",
				dataType: "html",
...
<div class="p_container">
	<div id="divCenter" style="float:left;width:800px;height:400px;">
		<form id="queryForm">
			...
			<!-- <input type="hidden" name="sl" value="fin.selectIncomeListPage" />
			<input type="hidden" name="rp" value="finance/cash/income-join-list-table" />
-->
	...
	<div id="divRight" style="float: left; width: 150px;height:400px;">
		<h2>已选择：</h2>
		<div class="clear"></div>
		<ul id="ulSel"></ul>
	</div>
