...
<body>
	<div class="p_container">
		<form id="queryForm">
			...
			<input type="hidden" name="pay_direct" value="0" />
			<input type="hidden" name="sl" value="fin.selectCashRecordListPage" />
			<input type="hidden" name="rp" value="finance/cash/pay-list-table" />
			<div class="p_container_sub">
				<div class="searchRow">
					<ul>
						<li class="text">付款日期:</li>
					...
					<ul> -->
						...
						<input type="button" id="btnPayAdd" onclick="toPayAdd()" class="button button-primary button-small" value="新增付款"></li>
					</ul>
				</div>
			</div>
		</form>
...
<script type="text/javascript">
	...
	function toPayAdd(){
		newWindow('新增付款', '<%=staticPath%>/finance/payAdd.htm');
	}
	
	function toPayEdit(id){
		newWindow('修改付款', '<%=staticPath%>/finance/payAdd.htm?payId='+ id);
	}
	
	function deletePay(oid){
