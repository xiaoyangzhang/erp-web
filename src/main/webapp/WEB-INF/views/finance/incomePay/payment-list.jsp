			...
			<div class="p_container_sub">
				<div class="searchRow">
					<ul>
						...
						<input type="button" id="btnPayAdd" onclick="toPaymentAdd()" class="button button-primary button-small" value="新增付款"></li>
					</ul>
				</div>
			</div>
		</form>
...
function queryList(page, pagesize) {
	...
	$("#queryPaymentForm").ajaxSubmit(options);
}
/* 点击查询事件 */
function searchBtn() {
...
/* 新增收付款 */
function toPaymentAdd(){
	newWindow('新增付款', '<%=staticPath%>/financePay/paymentAdd.htm');
}

/* 修改付款 */
function toPaymentEdit(id){
	newWindow('修改付款', '<%=staticPath%>/financePay/paymentAdd.htm?payId='+ id);
}
