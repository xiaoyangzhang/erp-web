...
<div class="p_container">
		...
		<form id="paymentOrderAddForm">
			...
			<input type="hidden" name="rp" value="finance/incomePay/payment-order-list-table"/>
...
function queryList(page, pagesize) {
	...
	var options = {
		...
		success: function (data) {
			$("#paymentOrderAddDiv").html(data);
		},
		error: function (XMLHttpRequest, textStatus, errorThrown) {
			$.error("服务忙，请稍后再试");
		}
	}
	$("#paymentOrderAddForm").ajaxSubmit(options);
}
