...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    <style type="text/css">    
    	...
    	.w_tab{height: 25px;line-height: 16px;margin-left: 10px;}
...
<body>
	<ul class="w_tab">
			<li><a href="orgUserDateRightTree.htm?employeeId=${employeeId }" class="selected">我看谁</a></li>
			<li><a href="orgUserDateRightTreeReverse.htm?employeeId=${employeeId }" >谁看我</a></li>
	</ul>
