...
<div class="page-container">
	<form id="loginForm" action="visa.do" method="post">
		<div class="loginBox">
			<div class="head">
				<p class="logo left"></p>
				<h1>签证进度查询</h1>
			...
			<div class="row">
				...
				<p class="right">
					<input type="text" id="loginName" name="loginName" value="${loginName }"
						placeholder="请输入手机号码" maxlength="20" class="input inp_w1" />
				</p>
			</div>
			<!-- <div class="clear"></div>
			<div class="row">
...
<script type="text/javascript" src="<%=staticPath %>/assets/js/visa.js"></script>
<script type="text/javascript">
	$(function(){
