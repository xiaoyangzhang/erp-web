        ...
        <div class="p_container_sub" >
	    	...
	    	<form id="searchProductForm">
                <dd class="inl-bl">
                    ...
                    <div class="dd_right">
                    	<input name="code" type="text" class="w-100"/>
                ...
                <%-- <dd class="inl-bl">
                     ...
                     <div class="dd_right">
                     	<select name="destProvinceId" id="provinceCode" style="width: 100px;">
	    					<option value="">请选择省</option>
	    					<c:forEach items="${allProvince}" var="province">
								<option value="${province.id }">${province.name }</option>
							</c:forEach>
	    				</select>
	    				<select name="destCityId" id="cityCode" style="width: 100px;" >
                ...
                <!-- <dd class="inl-bl">
                    ...
                    <div class="dd_right"><input id="Text1" type="text" name="name" /></div>
                    <div class="clear"></div>
                </dd>
                <dd class="inl-bl">
