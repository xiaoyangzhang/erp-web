...
<body>
				...
				<div class="p_container">
					 <div class="p_container_sub">
						...
						<form id="routeForm" method="post">
							...
							<input type="hidden" id="groupId" name="tourGroup.id" value="${tourGroup.id}" />
							...
							<div>
								...
								<div class="dd_right">
									<input type="text" name="tourGroup.productBrandName"
										placeholder="品牌" class="IptText100" />~<input type="text"
										name="tourGroup.productName" placeholder="名称" class="IptText300" />
								</div>
								<div class="clear"></div>
							</div>
							<div class="content1">
	...
	<script type="text/javascript"
		src="<%=ctx%>/assets/js/web-js/sales/addRouteList.js"></script>
	<script type="text/javascript"
