		...
		<div class="p_container_sub" id="tab1">
			<form id="SpecialGroupOrderForm">
				...
				<table border="0" cellspacing="0" cellpadding="0" class="searchTab">
					...
					<tr>
						<td>订单号：</td>
						<td><input type="hidden" name="groupOrder.id"
							value="${vo.groupOrder.id}" /> <input type="hidden"
							name="groupOrder.orderType" value="-1" /> <input type="text"
							name="groupOrder.orderNo" value="${vo.groupOrder.orderNo}"
							readonly="readonly" placeholder="订单号系统自动生成" /></td>
						<td><i class="red">* </i>出团日期：</td>
						<td><input type="text" name="groupOrder.departureDate"
							class="Wdate"
					...
					<tr>
						...
						<td>客源地：</td>
						<td><input type="hidden" name="groupOrder.provinceName"
							class="IptText300" id="provinceName"
							value="${vo.groupOrder.provinceName }" /> <select
							name="groupOrder.provinceId" id="provinceCode">
					...
					<tr>
						...
						<td>组团社团号：</td>
						<td><input type="text" name="groupOrder.supplierCode"
							class="IptText300" placeholder="组团社团号"
							value="${vo.groupOrder.supplierCode }" /></td>
					</tr>
					<tr>
						<td>组团社联系人：</td>
						<td><input type="text" name="groupOrder.contactName"
							id="contactName" class="IptText100" placeholder="姓名"
					...
					<tr>
						...
						<td><input style="width: 92px;" type="text"
							...
							name="groupOrder.numChild" placeholder="小孩数"
							value="${(empty vo.groupOrder.numChild)?0:vo.groupOrder.numChild}" />
							~<input style="width: 92px;" type="text"
							name="groupOrder.numGuide" placeholder="全陪数"
					...
					<tr>
						...
						<td><input type="hidden" name="groupOrder.productBrandId"
							value="${vo.groupOrder.productBrandId }" /> <input type="text"
							name="groupOrder.productBrandName"
							value="${vo.groupOrder.productBrandName }" readonly="readonly" />
							~ <input type="hidden" name="groupOrder.productId" id="productId"
							value="${vo.groupOrder.productId }" /> <input type="text"
							name="groupOrder.productName"
							value="${vo.groupOrder.productName }" style="width: 300px"
							readonly="readonly" /> <a href="javascript:void(0)"
							onclick="importRoute();">选择产品</a></td>
							<td></td>
							<td></td>
					</tr>
				</table>
								...
								<tbody id="newPriceData">
									<c:forEach items="${vo.groupOrderPriceList }" var="price"
										...
										<tr>
											...
											<td><textarea class="l_textarea_mark" <c:if test="${price.stateFinance==1 }"> style="width:80%;border-color: red" readonly="readonly" </c:if>
											...
											<a href="javascript:void(0);"
												onclick="delPriceTable(this,'newPrice')">删除</a>
												</c:if>
												</td>
										</tr>
							...
							<table cellspacing="0" cellpadding="0" class="w_table">
								<thead>
									<tr>
										...
										<th width="8%">金额<i class="w_table_split"></i></th>
										<th width="5%"><a href="javascript:;"
											onclick="addCost(1,'newCost');" class="def">增加</a></th>
									</tr>
								</thead>
								<tbody id="newCostData">
									<c:forEach items="${vo.groupOrderCostList }" var="cost"
										...
										<tr>
											...
											<td><a href="javascript:void(0);"
												onclick="delCostTable(this,'newCost')">删除</a></td>
										</tr>
