...
<script type="text/html" id="trans_template">
					<tr>
						<td>
							...
							<input type="hidden" name="groupOrderTransportList[{{index}}].type" value="0" />
							<input type="hidden" name="groupOrderTransportList[{{index}}].sourceType" value="1" />
							<input type="hidden" name="groupOrderTransportList[{{index}}].method" value="154" />
							<input type="hidden" name="groupOrderTransportList[{{index}}].orderId" value="${groupOrder.id}" />
						</td>
						<td>
