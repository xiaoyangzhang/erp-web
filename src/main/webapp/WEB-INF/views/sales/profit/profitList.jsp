		...
		<div id="tabContainer">
			<ul class="w_tab">
				<li><a href="#list_search" onclick="loading(0)"
					class="selected">按订单查询</a></li>
				<li><a href="#list_search1" onclick="loading(1)" class="">按团查询</a></li>
				<li class="clear"></li>
			</ul>
		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "toProfitQueryList.htm");
				}
			} else {
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "toProfitQueryListByTour.htm");
				}
			}
		} ;
	</script>
