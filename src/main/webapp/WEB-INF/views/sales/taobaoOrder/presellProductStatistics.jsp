...
//queryList();
		...
		function queryList(page, pagesize) {
			...
			var options = {
				url: "<%=staticPath %>/taobao/presellProductStatistics_table.do",
				type: "post",
				dataType: "html",
		...
		function detail(obj){
			var url = "/taobao/presellTaobaoOriginalOrder.htm?startMin="+$("#today").val()+"&startMax="+$("#today1").val()
					+"&isBrushSingle="+$("#isBrushSingle").val()+"&myStoreId="+$("#myStoreId").val()+"&title="+$("#title").val()+"&outerIid="+obj;
			newWindow('预售淘宝原始单','<%=staticPath %>'+url);
		}
			...
			<div class="p_container_sub">
				<div class="searchRow">
					<ul>
						...
						<li>
							<select name="isBrushSingle" id="isBrushSingle">
