...
<table cellspacing="0" cellpadding="0" class="w_table">
	...
	<tr>
		...
		<th style="width: 5%">业务类别<i class="w_table_split"></i></th>
		<th style="width: 15%">平台来源<i class="w_table_split"></i></th>
		<th style="width: 16%">产品品牌<i class="w_table_split"></i></th>
		<th style="width: 19%">产品名称<i class="w_table_split"></i></th>
		<th style="width: 4%">成人数<i class="w_table_split"></i></th>
		<th style="width: 4%">儿童数<i class="w_table_split"></i></th>
		<th style="width: 4%">团款收入<i class="w_table_split"></i></th>
		<th style="width: 4%">其他收入<i class="w_table_split"></i></th>
		<th style="width: 4%">供应商应付<i class="w_table_split"></i></th>
		<th style="width: 4%">毛利<i class="w_table_split"></i></th>
	</tr>
	</thead>
	<tbody id="tbody">
