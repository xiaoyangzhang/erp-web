...
<body class="bodys">
	...
	<div align="center" class="divs">
		...
		<table style="width: 100%; border-collapse: collapse; margin: 0px" border="1">
			...
			<tr>
				<td style="text-align: center">总购</td>
				<td></td>
		...
		<table style="width:100%;border-collapse:collapse;margin: 0px"  border="1">
				<tr>
		  			...
		  			<th style="width:10%">接送方式</th>
		  			<th style="width:5%">人数</th>
			  			<th width="80%" height="100%">
						<table border="1" class="in_table">
							<tbody>
									<tr>
										<th style="width:12%">姓名</th>
										<th style="width:16%">客源地</th>
										<th style="width:16%">身份证</th>
										<th style="width:7%">人均</th>
		  								<th style="width:7%">银店</th>
		  								<th style="width:7%">外围（翡翠）</th>
		  								<th style="width:7%">七彩（玉）</th>
		  								<th style="width:7%">七彩（茶）</th>
		  								<th style="width:7%">七彩（黄龙玉）</th>
		  								<th style="width:7%">七彩（其他）</th>
	  			...
	  			<c:forEach items="${gops}" var="l" varStatus="v">
		  			<tr>
						...
						<table border="1" class="in_table">
							...
							<tbody>
								<c:forEach items="${l.guests}" var="v">
									<tr>
										<td style="width:12%">${v.name }</td>
										<td style="width:16%">${v.nativePlace }</td>
										<td style="width:16%">${v.certificateNum }</td>
											<td style="width:7%">&nbsp;</td>
			  								<td style="width:7%">&nbsp;</td>
			  								<td style="width:7%">&nbsp;</td>
			  								<td style="width:7%">&nbsp;</td>
	...
	<script type="text/javascript">
		function toExportWord(){
			window.location = "download.htm?groupId=${groupId}&num=8";
		}
		function opPrint() {
			window.print();
		}
