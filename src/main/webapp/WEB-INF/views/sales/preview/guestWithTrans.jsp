	...
	<table style="width: 100%; border-collapse: collapse; margin: 0px;font-size: 10px;"
		...
		<c:forEach items="${orderList }" var="po" varStatus="i">
			<tr>
				...
				<td class="rich_text" width="12%">${po.airPickup }</td>
				<td class="rich_text" width="12%">${po.airOff }</td>
				<td class="rich_text" width="12%">${po.trans }</td>
			...
			<tr>
				<td colspan="5" align="right">房量总计：</td>
...
<script type="text/javascript">
	...
	function toExportWord() {
		window.location = "download.htm?groupId=${tourGroup.id}&num=6"
	}
</script>