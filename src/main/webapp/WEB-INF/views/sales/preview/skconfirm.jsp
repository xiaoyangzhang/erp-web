				...
				<tr>
			  	...
			  	<c:forEach items="${vos}" var="v" varStatus="vs">
			  		<tr>
			  			...
			  			<td style="text-align: center;width:12%"><fmt:formatNumber value="${v.totalPrice}" type="currency" pattern="#.##"/></td>
			  		</tr>
				...
				<tr>
		  		...
		  		<c:forEach items="${gopps}" var="gopp" varStatus="vs">
			  		<tr>
			  			...
			  			<td style="width:13%" class="rich_text">${gopp.certificateNums}</td>
			  			<td style="width:12%">${gopp.remark}</td>
			  		</tr>
			  	</c:forEach>
			</table>
			<table style="width:100%;border-collapse:collapse;margin: 0px"  border="1">
	...
	<script type="text/javascript">
		$(function() {
		    ...
		    $("#supplier").bind("change",function(){
		    	window.location = "toSKConfirmPreview.htm?groupId=${groupId}&supplierId="+$("#supplier option:selected").val() ;
		    }); 
		});
