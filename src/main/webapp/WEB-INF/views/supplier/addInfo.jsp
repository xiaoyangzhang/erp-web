		...
		<dl class="p_paragraph_content">
			...
			<dd>
				<c:if test="${supplierInfo.supplierType==1}">
					...
					<div class="dd_right"><select name="className" placeholder="请选择">
						<c:forEach items="${travelagencyClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				</c:if>
				...
				<c:if test="${supplierInfo.supplierType==2}">
					<div class="dd_left">分类：</div>
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${restaurantClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==3}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${hotelClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==4}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${fleetClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==5}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${scenicspotClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==6}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${shoppingClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==7}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${entertainmentClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==8}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${guideClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==9}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${airticketagentClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==10}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${trainticketagentClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==11}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${golfClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==12}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${otherClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==15}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${insurancClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
				...
				<c:if test="${supplierInfo.supplierType==16}">
					...
					<div class="dd_right"><select name="className"
												  placeholder="请选择">
						<c:forEach items="${localtravelClassList}" var="level">
							<option value="${level.value }"
									<c:if test="${supplierInfo.className==level.value }"> selected="selected" </c:if>>${level.value }</option>
						</c:forEach>
					</select></div>
