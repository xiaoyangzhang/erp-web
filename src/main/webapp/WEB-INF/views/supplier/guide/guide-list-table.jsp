...
<script type="text/javascript">
	function del(id){
		...
		$.confirm("确认删除吗？", function() {
			$.getJSON("delPublicGuide.do?id=" + id, function(data) {
				if (data.success) {
		...
		<div class="guide_detail">
			<div class="guide_butt">
				<c:if test="${optMap['EDIT'] }">
					<a  onclick="newWindow('修改导游','<%=staticPath %>/supplier/editGuide.htm?id=${guide.id }')" href="javascript:void(0)" class="button button-rounded button-tiny">修改</a>
