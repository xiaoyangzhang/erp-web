...
<div class="p_container">
    <ul class="w_tab">
        <li><a href="listPrice.htm?state=1" <c:if test="${state eq 1}">class="selected"</c:if>>待上架</a></li>
        <li><a href="listPrice.htm?state=2" <c:if test="${state eq 2}">class="selected"</c:if>>已上架</a></li>
        <li class="clear"></li>
    </ul>
