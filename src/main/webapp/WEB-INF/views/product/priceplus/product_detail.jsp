        ...
        <div class="banner">
            <ul id="banner_list">
                ...
                <c:forEach items="${productInfoVo.productAttachments}" var="imgs">
                    <li><img style="" src="${config.images340Url }${cf:thumbnail(imgs.path,'360x360')}"/></li>
                </c:forEach>
				</c:if>
            </ul>
            <ol id="banner_btn">
        ...
        <div class="rdaycontainer">
            <c:forEach items="${productRouteVo.productRoteDayVoList}" var="dayVo" varStatus="s">
                <div id="day${s.index + 1}" class="rday">
                    <div class="oneday">
                        <div class="one">
                            <img src="<%=staticPath%>/assets/css/product/img/day.png"/>

                            <p day-num="${dayVo.productRoute.dayNum}" class="daysLabel"></p>

                        </div>
                        <div class="two">
                            <img src="<%=staticPath%>/assets/css/product/img/feiji.png"/>
                                    ...
                                    <span class="rote_tanslate"><label class = "diqu_txt">${traffic.cityDeparture}</label>
                                        <c:choose>
                                            <c:when test="${traffic.typeId == 1}">
                                                <img src = "<%=staticPath%>/assets/img/plane.png" class = "city_img"/>
                                            </c:when>
                                            <c:when test="${traffic.typeId == 2}">
                                                <img src = "<%=staticPath%>/assets/img/train.png" class = "city_img"/>
                                            </c:when>
                                            <c:when test="${traffic.typeId == 3}">
                                                <img src = "<%=staticPath%>/assets/img/bus.png" class = "city_img"/>
                                            </c:when>
                                            <c:when test="${traffic.typeId == 4}">
                                                <img src = "<%=staticPath%>/assets/img/ship.png" class = "city_img"/>
                                            </c:when>
                                        </c:choose>
                        ...
                        <div class="three">
                            <img src="<%=staticPath%>/assets/css/product/img/food.png"/>
                        ...
                        <div class="four">
                            <img src="<%=staticPath%>/assets/css/product/img/jiudian.png"/>
                            <p>
                        ...
                        <div class="five">
                            <img src="<%=staticPath%>/assets/css/product/img/jingdian.png"/>
                        ...
                        <div class="six">
                            <div class="dengpao">
                                <img src="<%=staticPath%>/assets/css/product/img/dengpao.png"/>
...
<script src="<%=staticPath%>/assets/js/jquery.idTabs.min.js" type="text/javascript"></script>
<script src="<%=staticPath%>/assets/js/jquery.autoScroll.js" type="text/javascript"></script>
<script src="<%=staticPath%>/assets/js/web-js/product/product_detail_plus.js"></script>
