...
<script type="text/javascript" src="<%=ctx %>/assets/js/web-js/product/productInfo_edit.js"></script>
</head>
<body>
	 <div class="p_container" >
	    <ul class="w_tab">
	    	...
	    	<%--<li><a href="price/list.htm?productId=${productId }">价格设置</a></li>--%>
	    	<li class="clear"></li>
	    </ul>
	    ...
	    <div class="p_container_sub" id="tab1">
	    	...
	    	<dl class="p_paragraph_content">
	    		<dd>
	    			...
	    			<div class="dd_right"><input type="text" name="productInfo.code" pid="${vo.productInfo.id}"  value="${vo.productInfo.code}" class="IptText300" placeholder="产品编码" />
	    				<input type="hidden" name="productInfo.id" value="${vo.productInfo.id}" />
	    			</div>
					<div class="clear"></div>
	    		</dd> 
	    		<%-- <dd>
