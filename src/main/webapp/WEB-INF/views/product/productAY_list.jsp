            ...
            <form id="searchProductForm">
                ...
                <dd class="inl-bl">
                    ...
                    <div class="dd_right">
                        ...
                        <input type="text" name="operatorName" id="operatorName" stag="userNames"
                               value="" readonly="readonly" onclick="showUser()"/>
                        <input name="operatorIds" id="operatorIds" stag="userIds" value=""
                               type="hidden" value=""/>
                    </div>
                </dd>
                    ...
                    <div class="dd_right">
                        ...
                        <c:if test="${optMap['EDIT'] }">
                            <a href="javascript:void(0)"
                               ...
                               class="button button-primary button-small">新增</a>
                            <button type="button" onclick="proImport()"
                                    class="button button-primary button-small">产品系统导入
                            </button>
                        </c:if>
