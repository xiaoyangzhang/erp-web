...
var opGrid = {
	...
	loadGrid: function(){
		...
		$("#tableDiv").jqGrid({
            ...
            colNames: ['团号', '日期', '成人', '儿童', '全陪', '产品线路', '组团社','地接社','计调','团费','其他收入','购物收入','地接','房费','餐费','车费','门票','机票','火车票','保险','其他支出','总收入','总成本','毛利','人均毛利'],
            colModel: [
              ...
              {name: 'productName', index: 'productName', width: 300, align: "left", sortable: false,
				...
				{name: 'incomeShop',index: 'incomeShop',width: 80, align: "right", sortable: false, formatter:opGrid.formatMoneyCell},
				...
				{name: 'totalIncome',index: 'totalIncome',width: 80, align: "right", sortable: false, formatter:opGrid.formatMoneyCell},
				{name: 'totalExpense',index: 'totalExpense',width: 80, align: "right", sortable: false, formatter:opGrid.formatMoneyCell},
				{name: 'totalProfit',index: 'totalProfit',width: 80, align: "right", sortable: false, formatter:opGrid.formatMoneyCell},
			...
			var options = {
			    	...
			    	success:function(data){
			    		...
			    		$("#tableDiv").footerData("set",{groupCode:"页合计："
			    			...
			    			,totalIncome:pageObj.totalIncome
							,totalExpense:pageObj.totalExpense
							,totalProfit:pageObj.totalProfit
						...
						$newFooterRow.find("td[aria-describedby*='_incomeShop']").html(opGrid.formatMoney(data.incomeShop));
