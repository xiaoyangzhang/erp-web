	    ...
	    <div class="p_container_sub">
	    	<dl class="p_paragraph_content">
	    		...
	    		<dd class="inl-bl">
					...
					<div class="dd_right">
						<input type="hidden" name="sourceTypeName" class="IptText300"  id="sourceTypeName" />
	    		...
	    		<dd class="inl-bl">
	    			<div class="dd_left">
						<button type="button" onclick="searchBtn();" class="button button-primary button-rounded button-small">查询</button>	 
	    			</div>
					<div class="dd_left">
...
function queryList(page,pagesize) {	
    ...
    var options = {
   		url:"<%=path%>/tjGroup/selectLineProfits.do",
    	type:"post",
    	dataType:"html",
