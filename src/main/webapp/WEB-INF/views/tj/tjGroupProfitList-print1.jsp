	  	...
	  	<div class="print-tab mt-20" style="overflow-x:scroll;">
	  		<table cellspacing="0" cellpadding="0" class="w_table" style="min-width:3350px;" > 
				...
				<tr>
					...
					<td><fmt:formatNumber value="${pageTotalTj.totalIncome-pageTotalTj.incomeShop}" pattern="#.##" type="currency"/></td>
					<td><fmt:formatNumber value="${pageTotalTj.totalExpense}" pattern="#.##" type="currency"/></td>
					<td><fmt:formatNumber value="${pageTotalTj.totalProfit-pageTotalTj.incomeShop}" pattern="#.##" type="currency"/></td>
...
function exportExcel(){
	...
	$("#export").attr("href",'<%=staticPath%>/tjGroup/getGroupProfitExcl1.do?'+param); 
}
