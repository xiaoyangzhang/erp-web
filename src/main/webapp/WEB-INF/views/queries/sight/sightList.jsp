...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/sight/sightTable" /> 
			...
			<div class="p_container_sub">
				<div class="searchRow">
					<ul>
						...
						</select> <input id="supplierName" name="supplierName"
							style="width: 200px" type="text" placeholder="请输入商家名称" /></li>
						<li class="text">产品</li>
...
function toDetail(supplierId, supplierName){
	...
	var url = "<%=ctx%>/query/sightBooking.htm?"+
	...
	//console.log(url);
	newWindow("门票订单详情", encodeURI(url));
