...
<body>
	<div class="p_container">
		<!-- <ul class="w_tab">
			<li><a href="javascript:void(0);"  class="selected">产品客户购物统计</a></li>
			 <li class="clear"></li>
		</ul> -->
		<form id="form" method="post">
			<input type="hidden" name="page" id="page" />
			<input type="hidden" name="pageSize" id="pageSize" value="${pageBean.pageSize }" />
			<input type="hidden" name="sl" value="booking.selectProductShopListPage" />
			<input type="hidden" name="rp" value="queries/productShopping/productShoppingTable" />
