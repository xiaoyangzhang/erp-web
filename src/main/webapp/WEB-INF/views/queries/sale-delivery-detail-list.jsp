...
function queryList(page,pagesize) {	
	...
	function toPreview(){
	window.open("<%=ctx%>/query/saleDeliveryDetailPreview.htm?dateType="+$("#dateType").val()+"&start_min="+
			$("#startTime").val()+"&start_max="+$("#endTime").val()+"&supplier_name="+$("#supplierName").val()+"&productName="+$("#productName").val()+
			"&group_code="+$("#groupCode").val()+"&group_mode="+$("#groupMode").val()+"&djType="+$("#djType").val()
