...
<body>
	<div class="p_container">
		<ul class="w_tab">
		<li><a href="toGuideList.htm;"  class="selected">购物分类统计</a></li>
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="sl" value="shop.selectShoppingListPage" />
			<input type="hidden" name="rp" value="queries/shopStatistics/shopTable" />
			...
			<div class="searchRow">
				<ul style="margin-left: 25px;">
					...
					<li>
						...
						<input type="radio" checked="checked" id="shop" />购物店
