...
<body>
	<div class="p_container">
		<form id="form" method="post">
			...
			<input type="hidden" name="sl" value="shop.selectGuideManageListPage" />
			<input type="hidden" name="rp" value="queries/shopStatistics/guideManageTable" />
...
<!-- 						<input type="radio" checked="checked" id="guideManage" />导管 -->
