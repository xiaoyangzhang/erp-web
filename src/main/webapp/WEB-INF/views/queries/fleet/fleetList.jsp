...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/fleet/fleetTable" />
...
function toDetail(supplierId, supplierName){
	...
	var url = "<%=ctx%>/query/fleetDetailList.htm?"+
	...
	//console.log(url);
	newWindow("车辆订单详情", encodeURI(url));
