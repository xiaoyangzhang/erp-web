...
<body>
	<div class="p_container">
		...
		<form id="form" action="<%=ctx%>/query/hotelbooking.htm" method="post">
			...
			<input type="hidden" name="rp" value="queries/fleet/fleetDetailTable" />
			...
			<div class="searchRow">
				<ul>
						<li style="margin-left:30px;" ><select id="selectDate" name="selectDate">
							...
							<option value="1" ${condition.selectDate eq 1?'selected="selected"':'' }>用车日期</option>
					...
					<li class="text">座位数</li>
					<li><input name="carNumMin" id="carNumMin" style="width:30px" type="text"/>~<input name="carNumMax" id="carNumMax" style="width:30px" type="text"/></li>
					<li class="text">司机</li>
					<li><input name="driverName" id="driverName" type="text" style="width: 80px"/></li>
					<li class="text">车牌号</li>
					<li><input name="carLisence" id="carLisence" type="text" style="width: 80px"/></li>
				...
				<ul> 
					...
					<li>
						...
						<a href="javascript:void(0)" id="previewCar" onclick="toPreviewCar()"  class="button button-primary button-small" >打印</a>
					</li>
...
function toPreviewCar(){
	var url = "../query/fleetDetailPreview.htm?"+
	...
	"&carNumMin=" + $("#carNumMin").val() + 
	"&carNumMax=" + $("#carNumMax").val() + 
	...
	$("#previewCar").attr("target","_blank").attr("href",encodeURI(url));
