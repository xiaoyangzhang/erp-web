...
<body>
	<div class="p_container">
		...
		<form id="form" action="<%=ctx%>/query/hotelDetailList" method="post">
			...
			<input type="hidden" name="rp" value="queries/fleet/fleetJSFSTable" />
			...
			<div class="searchRow">
				<ul>
					...
					<li><input id="supplierName"  name="supplierName" style="width: 200px"type="text" value="" placeholder="商家名称"/></li>
					 <li class="text">产品</li>
