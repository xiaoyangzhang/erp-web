		...
		<div id="tabContainer">
			<ul class="w_tab">
				<li><a href="#list_search" onclick="loading(0)"
					class="selected">支出统计</a></li>
				<li><a href="#list_search1" id="bookingDetail" onclick="loading(1)" class="">支出明细</a></li>
				<li class="clear"></li>
			</ul>
		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "outcomeList.htm");
				}
			} 
			 else {
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "outcomeDetailList");
				}
			}
		} ;
	</script>
