	    	...
	    	<dl class="p_paragraph_content">
	    		<dd class="inl-bl">
	    			...
	    			<div class="dd_right grey">
						<input type="text" id="dateStart" name="startTime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="" /> —
	    				<input type="text" id="dateEnd" name="endTime" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" value="" />
	    			</div>
	    			<div class="clear"></div>
	    		</dd>
	    		<dd class="inl-bl">
	    		...
	    		<dd class="inl-bl">
	    			...
	    			<div class="dd_right grey">
	    				 <input type="text" name="productBrandName" id="productBrandName" value="" class="w-200" placeholder="请输入品牌或产品名称"/> 
	    		...
	    		<dd class="inl-bl">
					...
					<div class="dd_right grey">
						<select name="shopDetailDeploy.shoppingDataState">
...
function searchBtn() {
 ...
 function queryList(page,pageSize) {
	    ...
	    var url="supplierGuestSourceShoppingList.do";
