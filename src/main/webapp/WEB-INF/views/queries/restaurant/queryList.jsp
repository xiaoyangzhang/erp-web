		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "restaurantList.htm");
				}
			} else if(num==1){
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "restaurantBooking.htm");
				}
			}
			 else if(num==2){
				if ($("#list_search2").attr("src") == '') {
					$("#list_search2").attr("src", "restaurantDetailList.htm");
				}
			}
			 else {
					if ($("#list_search3").attr("src") == '') {
						$("#list_search3").attr("src", "restaurantJSFS.htm");
					}
				}
		} ;
	</script>
