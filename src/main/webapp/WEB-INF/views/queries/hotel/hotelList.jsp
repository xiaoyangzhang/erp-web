...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/hotel/hotelTable" /> 
			<input type="hidden" id="supplierId" name="supplierId" value="" /> 
			<input type="hidden" id="supplierType" name="supplierType" value="3" />
			<div class="p_container_sub">
				<div class="searchRow">
					<ul>
						...
						<li><input id="supplierName" name="supplierName"
							style="width: 200px" type="text" /></li>
						<li class="text">产品</li>
...
function toHotelDetail(supplierId, supplierName){
	//$("#supplierId").val(supplierId);
	var url = "<%=ctx%>/query/hotelBooking.htm?"+
	...
	//console.log(url);
	newWindow("酒店订单详情", encodeURI(url));
