...
<body>
	<div class="p_container">
		...
		<form id="form" action="<%=ctx%>/query/hotelbooking.htm" method="post">
			...
			<input type="hidden" name="rp" value="queries/hotel/hotelDetailTable" />
			...
			<div class="searchRow">
				<ul>
						<li style="margin-left:30px;" ><select id="selectDate" name="selectDate">
							...
							<option value="1" ${condition.selectDate eq 1?'selected="selected"':'' }>入住日期</option>
					...
					<li class="text">商家信息</li>
						...
						</select><input id="supplierName"  name="supplierName" style="width: 200px"type="text" value="${condition.supplierName}" placeholder="商家名称" /></li>
					<li class="text">产品</li>
