...
<body>
	<div class="p_container">
		...
		<form id="detailForm" action="<%=ctx%>/placeOrderQuery/placeOrderList.htm" method="post">
			<input type="hidden" name="page" id="page" />
			<input type="hidden" name="pageSize" id="pageSize" />
			<input type="hidden" name="sl" value="booking.placeOrderDetailListPage" />
			
			<input type="hidden" name="ssl" value="booking.bookingSupplierDetailTotal" />
			
			<input type="hidden" name="rp" value="queries/placeorder/placeOrderDetailTable" />
			...
			<div class="searchRow">
				<ul>
					...
					<li><select name="supplierType" style="width: 100px; text-align: right;">
					...
					<li><select name="provinceId" id="provinceCode"
						...
						</select><input id="supplierName"  name="supplierName" style="width: 180px"type="text" value="" placeholder="商家名称"/></li>
					 <li class="text">产品</li>
...
function queryList(page,pagesize) {	
	...
	var options = {
			url:"../placeOrderQuery/getSupplierStatisticsDetail",
			type:"post",
			dataType:"html",
