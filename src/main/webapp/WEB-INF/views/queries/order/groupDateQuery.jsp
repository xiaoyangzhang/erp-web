...
<body>
	<div class="p_container">
		<div id="tabContainer">
			<ul class="w_tab">
				<li><a href="#list_search" onclick="loading(0)" class="selected">今日出团</a></li>
				<li><a href="#list_search1" onclick="loading(1)" class="">今日散团</a></li>
				<li class="clear"></li>
			</ul>
		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "../query/groupDateQuery.htm?operType=0");
				}
			} else {
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "../query/groupDateQuery.htm?operType=1");
				}
			}
		} ;
	</script>
