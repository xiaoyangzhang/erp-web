	...
	<div class="p_container">
		<div class="p_container_sub pl-10 pr-10">
			<dl class="p_paragraph_content">
				<form method="post" id="groupDateEndListForm">
					...
					<dd class="inl-bl">
						<div class="dd_left">今日散团:</div>
						<div class="dd_right grey">
							<input name="endTime" type="text" id="endTime" class="Wdate"
	...
	function queryList(page,pageSize) {
		...
		var options = {
		    	...
		    	success:function(data){
		    		$("#content_end").html(data);
		    	},
		    	error:function(XMLHttpRequest, textStatus, errorThrown){
		    		$.error("服务忙，请稍后再试");
		    	}
		    };
		    $("#groupDateEndListForm").ajaxSubmit(options);	
	}
