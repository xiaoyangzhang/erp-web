...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/insurance/insuranceTable" /> 
...
function toDetail(supplierId, supplierName){
	...
	var url = "<%=ctx%>/query/insuranceBooking.htm?"+
	...
	//console.log(url);
	newWindow("保险订单详情", encodeURI(url));
