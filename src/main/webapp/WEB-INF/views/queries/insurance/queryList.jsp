		...
		<div id="tabContainer">
			<ul class="w_tab">
				<li><a href="#list_search" onclick="loading(0)"
					class="selected">保险统计</a></li>
				<li><a href="#list_search1" onclick="loading(1)" >订单统计</a></li>
				<li><a href="#list_search2" id="bookingDetail" onclick="loading(2)" >订单明细</a></li>
				<li><a href="#list_search3" onclick="loading(3)" >结算方式查询</a></li>
				<li class="clear"></li>
			</ul>
		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "insuranceList.htm");
				}
			} else if(num==1){
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "insuranceBooking.htm");
				}
			}
			 else if(num==2){
				if ($("#list_search2").attr("src") == '') {
					$("#list_search2").attr("src", "insuranceDetailList.htm");
				}
			}
			 else {
					if ($("#list_search3").attr("src") == '') {
						$("#list_search3").attr("src", "insuranceJSFS.htm");
					}
				}
		} ;
	</script>
