...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/airTicket/airTicketTable" />
...
function toDetail(supplierId, supplierName){
	...
	var url = "<%=ctx%>/query/airTicketDetailList.htm?"+
	...
	newWindow("机票订单详情", encodeURI(url));
