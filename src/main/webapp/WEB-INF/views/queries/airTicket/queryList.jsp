		...
		<div id="tabContainer">
			<ul class="w_tab">
				<li><a href="#list_search" onclick="loading(0)"
					class="selected">机票统计</a></li>
				<li><a href="#list_search1" onclick="loading(1)" class="">订单统计</a></li>
				<li><a href="#list_search2" onclick="loading(2)" id="bookingDetail" class="">订单明细</a></li>
		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "airTicketList.htm");
				}
			} else if(num==1){
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "airTicketBooking.htm");
				}
			}
			 else if(num==2){
				if ($("#list_search2").attr("src") == '') {
					$("#list_search2").attr("src", "airTicketDetailList.htm");
				}
			}
			 else {
					if ($("#list_search3").attr("src") == '') {
						$("#list_search3").attr("src", "airTicketJSFS.htm");
					}
				}
		} ;
	</script>
