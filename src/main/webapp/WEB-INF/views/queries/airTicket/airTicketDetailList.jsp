		...
		<form id="form" action="<%=ctx%>/query/paymentDetailList" method="post">
			...
			<div class="searchRow">
				<ul>
					...
					<li class="text">部门:</li>
					<li>
	    				<input type="text" name="orgNames" id="orgNames" style="width: 261px;" stag="orgNames" value="${condition.orgNames }" readonly="readonly" onclick="showOrg()"/>
						<input name="orgIds" id="orgIds" stag="orgIds" value="" type="hidden" value="${condition.orgIds }"/>	
						</li>
					<li class="text">计调:</li>
					<li>	
						<input type="text" name="saleOperatorName" id="saleOperatorName" style="width: 200px;" stag="userNames" value="${condition.saleOperatorName }" readonly="readonly" onclick="showUser()"/>
					...
					<li class="text">项目</li>
					<li><input id="type1Name" name="type1Name" type="text" value="${condition.type1Name}"/></li>
					</ul><ul>
