...
<table cellspacing="0" cellpadding="0" class="w_table">
 ...
 --%>					<c:choose>
				...
				<fmt:formatDate value="${dl.itemDate }"
					...
					<fmt:formatNumber value="${dl.itemNumMinus }" pattern="#.#" type="number"/>)<br/>
						</c:forEach>
						</c:otherwise>
					</c:choose>
	...
	<tbody>
		<tr>
			...
			<td></td>
			<td style="text-align: left" colspan="6" >合计：</td>
	...
	<tbody>
		<tr>
			...
			<td></td>
			<td style="text-align: left" colsd ><fmt:formatNumber value="${sum.totalCount}" pattern="#.##" type="number"/></td>
