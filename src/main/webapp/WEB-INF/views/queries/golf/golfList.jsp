...
<body>
	<div class="p_container">
		<ul class="w_tab">
			<li><a href="javascript:void(0);" onclick="toGolfList()" class="selected">高尔夫统计</a></li>
			<li><a href="javascript:void(0);" onclick="toGolfDetailList()">高尔夫明细</a></li>
			<li class="clear"></li>
		</ul>
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/golf/golfTable" />
