...
<body>
	<div class="p_container">
		<ul class="w_tab">
			<li><a href="javascript:void(0);" onclick="toGolfList(1)">高尔夫统计</a></li>
			<li><a href="javascript:void(0);" onclick="toGolfDetailList(1)" class="selected">高尔夫明细</a></li>
			<li class="clear"></li>
		</ul>
		<form id="form" action="<%=ctx%>/query/paymentDetailList" method="post">
			...
			<input type="hidden" name="rp" value="queries/golf/golfDetailTable" />
