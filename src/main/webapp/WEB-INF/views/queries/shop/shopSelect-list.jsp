    ...
    <div class="p_container" >
      <div id="tabContainer">
	    <ul class="w_tab">
				...
				<li><a href="shopSelectList.htm" class="selected">团购物查询</a></li>
	    	...
	    	<dl class="p_paragraph_content">
	    		<dd class="inl-bl">
	    			...
	    			<input type="hidden" id="searchPage" name="page"  value=""/><input type="hidden" id="searchPageSize" name="pageSize"  value=""/>
						<!-- <li> --><select id="selectDate" name="selectDate">
	    		...
	    		<dd class="inl-bl">
	    			...
	    			<div class="dd_right">
	    				<input type="text" name="saleOperatorName" id="saleOperatorName" value="" readonly="readonly" style="width: 130px"/>
