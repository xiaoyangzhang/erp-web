...
<script type="text/javascript"
	...
	function queryList(page,pagesize) {	
		...
		var options = {
				url:"../query/productProfitList.do",
				type:"post",
				dataType:"html",
...
<body>
	<div class="p_container">
		<!-- <ul class="w_tab">
			<li><a href="javascript:void(0);"  class="selected">产品盈亏统计</a></li>
			 <li class="clear"></li>
		</ul> -->
		<form id="form" method="post">
			<input type="hidden" name="page" id="page" />
			<input type="hidden" name="pageSize" id="pageSize"  value="${pageBean.pageSize }"/>
			<input type="hidden" name="sl" value="booking.selectProductProfitListPage" />
			<input type="hidden" name="rp" value="queries/productProfit/productProfitTable" />
