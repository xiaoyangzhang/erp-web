...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="sl" value="booking.selectAgeByProductListPage" />
			<!-- <input type="hidden" name="ssl" value="booking.selectAgeCount" /> -->
			<input type="hidden" name="rp" value="queries/byAge/ageTableByProduct" />
			...
			<div class="searchRow">
				...
				<!-- <li class="text">组团社</li>
					<li><input id="nameFull"  name="nameFull" style="width: 200px" type="text"/></li> -->
