		...
		<div id="tabContainer">
			<ul class="w_tab">
				<li><a href="#list_search" onclick="loading(0)"
					class="selected">按产品统计</a></li>
				<li><a href="#list_search1" onclick="loading(1)" class="">按产品+组团社统计</a></li>
				<li class="clear"></li>
				<li><a href="#list_search2" onclick="loading(2)" class="">按组团社统计</a></li>
				<li class="clear"></li>
			</ul>
		...
		var loading = function(num) {
			if (num == 0) {
				if ($("#list_search").attr("src") == '') {
					$("#list_search").attr("src", "ageListByProduct.htm");
				}
			} 
			else	if(num==1) {
				if ($("#list_search1").attr("src") == '') {
					$("#list_search1").attr("src", "toAgeListByProductAndAgency.htm");
				}
			}
			else	if(num==2) {
				if ($("#list_search2").attr("src") == '') {
					$("#list_search2").attr("src", "toAgeListByAgency.htm");
				}
			}
		} ;
	</script>
