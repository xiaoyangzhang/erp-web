...
<body>
	<div class="p_container">
		...
		<form id="form" method="post">
			...
			<input type="hidden" name="rp" value="queries/trainTicket/trainTicketTable" />
...
function toDetail(supplierId, supplierName){
	...
	var url = "<%=ctx%>/query/trainTicketDetailList.htm?"+
	...
	newWindow("火车票订单详情", encodeURI(url));
