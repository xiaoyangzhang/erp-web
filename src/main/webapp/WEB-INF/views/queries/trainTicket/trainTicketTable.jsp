	...
	<input type="hidden"  id="searchPageSize" value="${pageBean.pageSize }"/>
		<c:forEach items="${pageBean.result}" var="v" varStatus="vs">
			<tr>
				...
				<td ><fmt:formatNumber value="${v.totalNum eq null?0:v.totalNum}" pattern="#.#" type="number"/></td>
				<td><fmt:formatNumber value="${v.originalTotalBalance eq null?0:v.originalTotalBalance}" pattern="#.##" type="number"/></td>
				<td ><fmt:formatNumber value="${v.totalMon eq null?0:v.totalMon}" pattern="#.##" type="number"/></td>
				<td ><fmt:formatNumber value="${v.totalCashMon eq null?0:v.totalCashMon}" pattern="#.##" type="number"/></td>
				<td ><fmt:formatNumber value="${v.totalMon-v.totalCashMon eq null?0:(v.totalMon-v.totalCashMon)}" pattern="#.##" type="currency"/></td>
