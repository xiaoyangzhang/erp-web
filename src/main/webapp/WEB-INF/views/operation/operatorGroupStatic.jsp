...
<script type="text/javascript"
	src="<%=ctx%>/assets/js/operate/operatorGroupStatic.js"></script>
	<script type="text/javascript"
				...
				<form id="form" method="post" >
					...
					<div class="dd_left">计调:</div>
						<div class="dd_right">
							...
							<input name="operatorIds" id=""operatorIds"" stag="userIds"  type="hidden" value="${groupOrder.saleOperatorIds}"/> 
						</div>
						<div class="clear"></div>
					</dd>
					<dd class="inl-bl">	
