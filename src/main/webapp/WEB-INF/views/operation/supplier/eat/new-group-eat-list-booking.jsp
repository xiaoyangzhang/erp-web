	...
	<p class="p_paragraph_title" style="margin: 0;">
		<b>餐饮安排</b>
			<a class="button button-primary button-small"
				...
				onclick="newWindow('新增餐饮订单','<%=ctx %>/booking/newToAddSight?groupId=${groupId }&supplierType=${supplierType}')">新增</a>&nbsp;&nbsp;&nbsp;
		<a class="button button-primary button-small"
					...
					<tr>
						...
						<td>
							...
							onclick="printOrder(${booking.id})">打印</a>
								<a class="def" href="javascript:void(0)"
									onclick="newWindow('修改餐饮订单','<%=staticPath %>/booking/newToAddSight?groupId=${booking.groupId }&bookingId=${booking.id}&supplierType=${supplierType}')">修改</a>
								<a class="def" href="javascript:void(0)"
