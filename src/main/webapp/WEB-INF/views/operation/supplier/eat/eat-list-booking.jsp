          			...
          			<tr>
						...
						<c:otherwise>
          				...
          				<td>
							...
							<a class="def" href="javascript:void(0)" onclick="newWindow('查看餐饮订单','<%=staticPath %>/booking/viewSupplier.do?groupId=${booking.groupId }&bookingId=${booking.id}')">查看</a>
						...
						<a class="mr-10 blue" href="javascript:void(0)" onclick="confirmState(this,${booking.id })">确认</a>
							...
							<c:if test="${optMap['EDIT'] && (booking.stateFinance==null || booking.stateFinance==0 ) }">
		         			<a class="def" href="javascript:void(0)" onclick="newWindow('修改餐饮订单','<%=staticPath %>/booking/toAddEat?groupId=${booking.groupId }&bookingId=${booking.id}')">修改</a>
							</c:if>
