		...
		<p class="p_paragraph_title" style="margin: 0;">
			<b>车辆安排</b>
				<a class="button button-primary button-small"
					...
					onclick="newWindow('新增车辆订单','<%=ctx %>/booking/newToAddSight?groupId=${groupId}&supplierType=${supplierType}')">新增</a>&nbsp;&nbsp;&nbsp;
			<a class="button button-primary button-small"
							...
							<td>
								...
								<div class="btn-hide" id="asd">	
									...
									<a class="button button-primary button-small" href="javascript:void(0)" id="preview" onclick="toPreview(${booking.id})">打印</a>
										<a class="def" href="javascript:void(0)"
											onclick="newWindow('修改车辆订单','<%=staticPath %>/booking/newToAddSight?groupId=${booking.groupId }&bookingId=${booking.id}&supplierType=${supplierType}')">修改</a>
										<a class="def" href="javascript:void(0)"
