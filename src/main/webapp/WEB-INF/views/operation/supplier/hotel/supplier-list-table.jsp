	    		...
	    		<dd>
    			 <div class="pl-10 pr-10" >
                     <table cellspacing="0" cellpadding="0" class="w_table" > 
		             	<col width="4%" /><col width="13%" /><col width="5%" /><col width="5%" /> <col width="15%" />
		             	<col width="15%" /><col width="8%" /><col width="8%" /><col width="5%" /><col width="5%" /><col width="12%" /><col width="5%" />
			             <thead>
			             	<tr>
			              	  ...
			              	  <tr> 
				                  ...
				                  ${fn:replace(groupInfo.bookSupplierName,',','</br>') }
				                  	...
				                  	<c:if test="${groupInfo.groupState eq 1}">
				                  		...
				                  		<c:if test="${groupInfo.bookSupplierName!=null }">
				                  		<a href="javascript:void(0)" class="def"  id="preview" onclick="groupPreview(${groupInfo.groupId })" >
											打印</a></c:if>
				                  </td>
				               </tr>
			              </c:forEach>
...
function groupPreview(groupId){
	window.open("<%=staticPath %>/booking/groupHotelDetailPreview.htm?groupId="+groupId);
