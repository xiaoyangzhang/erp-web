	...
	<p class="p_paragraph_title" style="margin: 0;">
		<b>酒店安排</b>
			<a class="button button-primary button-small"
				...
				onclick="newWindow('新增酒店订单','<%=ctx %>/booking/newToAddSight?groupId=${groupId }&supplierType=${supplierType}')">新增</a>&nbsp;&nbsp;&nbsp;
		<a class="button button-primary button-small"
					...
					<tr>
						...
						<td>
							...
							<a class="def" href="javascript:void(0)"  onclick="toPreviewDetail(${booking.id})">打印</a>
								<a class="def" href="javascript:void(0)"
									onclick="newWindow('修改酒店订单','<%=staticPath %>/booking/newToAddSight?groupId=${booking.groupId }&bookingId=${booking.id}&supplierType=${supplierType}')">修改</a>
								<a class="def" href="javascript:void(0)"
									onclick="del(this,'${booking.id}','${booking.supplierType}')">删除</a>
								<a class="def" href="javascript:void(0)"
									onclick="newWindow('修改酒店订单数量','<%=staticPath %>/booking/toAddHotel?groupId=${booking.groupId }&bookingId=${booking.id}&editType=0')">编辑数量</a>
							</div>
							</div>
						</td>
					</tr>
