				                 ...
				                 <td style="text-align: left">
				                  ...
				                  <td > --%>
				                  	...
				                  	<c:if test="${groupInfo.groupState eq 1}">
				                  			...
				                  			<a class="def" href="javascript:void(0)" onclick="newWindow('新增支出','<%=staticPath %>/booking/editOutcome.htm?groupId=${groupInfo.groupId }')">新增</a>
				                  		</c:if>
				                  		</c:if>
				                  </td>
				               </tr>
...
$(document).ready(function () {
 ...
 function loadData(containerId, groupId, supplierType){
		 ...
		 $("#"+containerId).load("outcomeBookingInfo.htm?groupId="+groupId);
