...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
 <%@ include file="../../../../include/path.jsp" %>
          	...
          	<div class="in_tab mb-30">
          		...
          		<p class="in_tab_title"><b>火车票订单</b></p>
          		<form id="bookingTrain" action="">
          		<table class="in_tab_body" border="1" cellspacing="0" cellpadding="0">
 					...
 					<col width="10%" /><col width="10%" /><col width="10%" /><col width="10%" /><col width="6%" />
          			...
          			<tr>
          				...
          				<div class="tab-operate">
							...
							<a class="def" href="javascript:void(0)" onclick="newWindow('查看火车票订单','<%=staticPath %>/booking/viewSupplier.do?groupId=${booking.groupId }&bookingId=${booking.id}')">查看</a>
						...
						<a class="def" href="javascript:void(0)" onclick="confirmState(this,${booking.id })">确认</a>
							...
							<c:if test="${optMap['EDIT'] && (booking.stateFinance==null || booking.stateFinance==0 ) }">
		         			...
		         			<a class="def" href="javascript:void(0)" onclick="newWindow('修改火车票订单','<%=staticPath %>/booking/toAddTrainTicket?groupId=${booking.groupId }&bookingId=${booking.id}')">修改</a>
							</c:if>
