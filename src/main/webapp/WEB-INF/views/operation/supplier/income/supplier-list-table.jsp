			              	  ...
			              	  <tr> 
				                  ...
				                  <td > --%>
				                  	...
				                  	<c:if test="${groupInfo.groupState eq 1}">
				                  			...
				                  			<a class="def" href="javascript:void(0)" onclick="newWindow('新增收入','<%=staticPath %>/booking/editIncome.htm?groupId=${ groupInfo.groupId }')">新增</a>
				                  			</c:if>
				                  		</c:if>
				                  </td>
				               </tr>
...
$(document).ready(function () {
 ...
 function loadData(containerId, groupId, supplierType){
	 ...
	 $("#"+containerId).load("incomeBookingInfo.htm?groupId="+groupId);
