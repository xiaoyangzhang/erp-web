			              	  ...
			              	  <tr> 
				                  ...
				                  <td > --%>
				                  	...
				                  	<c:if test="${groupInfo.groupState eq 1}">
				                  			...
				                  			<a class="def" href="javascript:void(0)" onclick="newWindow('新增保险订单','<%=staticPath %>/booking/toAddInsurance?groupId=${ groupInfo.groupId }')">新增</a>
				                  			</c:if>
				                  		</c:if>
				                  </td>
				               </tr>
...
$(document).ready(function () {
 ...
 function loadData(containerId, groupId, supplierType){
	 ...
	 $("#"+containerId).load("insuranceBookingInfo.htm?groupId="+groupId);
