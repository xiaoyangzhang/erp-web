...
<div class="p_container">
	<p class="p_paragraph_title" style="margin: 0;">
		<b>保险订单</b>
		<c:if test="${optMap['YDAP_INSURANCE'] and groupCanEdit }">
			<a class="button button-primary button-small"
				href="javascript:void(0)"
				onclick="newWindow('新增保险订单','<%=ctx %>/booking/toAddInsurance?groupId=${groupId }')">新增</a>&nbsp;&nbsp;&nbsp;</c:if>
		<a class="button button-primary button-small"
					...
					<tr>
						...
						<td>
							<div class="tab-operate">
								...
								onclick="newWindow('查看保险订单','<%=staticPath %>/booking/viewSupplier.do?groupId=${booking.groupId }&bookingId=${booking.id}')">查看</a>
								<c:if
								...
								</c:if> <c:if test="${optMap['YDAP_INSURANCE'] && booking.canDelete==true}">
									<a class="def" href="javascript:void(0)"
