			              	  ...
			              	  <tr> 
				                  ...
				                  ${fn:replace(groupInfo.bookSupplierName,',','</br>') }
				                  	...
				                  	<c:if test="${groupInfo.groupState eq 1}">
				                  			...
				                  			<a class="def" href="javascript:void(0)" onclick="newWindow('新增门票订单','<%=staticPath %>/booking/toAddSight?groupId=${groupInfo.groupId }')">新增</a>
				                  			</c:if>
				                  		</c:if>
				                  </td>
				               </tr>
...
$(document).ready(function () {
 ...
 function loadData(containerId, groupId, supplierType){
	 ...
	 $("#"+containerId).load("sightBookingInfo.htm?groupId="+groupId);
