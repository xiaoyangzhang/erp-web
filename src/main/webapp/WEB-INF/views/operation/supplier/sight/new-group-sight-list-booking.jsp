	...
	<p class="p_paragraph_title" style="margin: 0;">
		<b>门票安排</b>
			<a class="button button-primary button-small"
				...
				onclick="newWindow('新增门票订单','<%=ctx %>/booking/newToAddSight?groupId=${groupId}&supplierType=${supplierType}')">新增</a>&nbsp;&nbsp;&nbsp;
		<a class="button button-primary button-small"
						...
						<td>
							...
							<a class="def" href="javascript:void(0)"
								onclick="printOrder(${booking.id})">打印</a> <c:if
									...
									<a class="def" href="javascript:void(0)"
										onclick="newWindow('修改门票订单','<%=staticPath %>/booking/newToAddSight?groupId=${booking.groupId }&bookingId=${booking.id}&supplierId=${booking.supplierId }&supplierType=${supplierType}')">修改</a>
