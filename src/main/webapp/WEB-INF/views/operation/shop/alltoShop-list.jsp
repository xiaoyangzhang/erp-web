	    		...
	    		<dd>
	    					...
	    					<thead>
	    					  ...
	    					  <c:forEach items="${shoplist}" var="shop" varStatus="status">
		    					<tr id="${shop.id }">
		    						...
		    						<td>
		    							<c:if test="${groupCanEdit }">
				    					<a href="edit${source }Shop.htm?id=${shop.id }&groupId=${groupId}" class="def">修改</a>		    									
					...
					<dl class="p_paragraph_content">
						<dd>
							...
							<div class="dd_right">
							<c:if test="${groupCanEdit }">
							<a href="editShop.htm?groupId=${groupId }" class="btn_guide_add button button-primary button-small ml-10">添加</a></c:if>
