	    ...
	    <div class="p_container_sub" id="tab1">
	    	...
	    	<dl class="p_paragraph_content">
	    		<dd>
	    			...
	    			<div class="dd_right">
	    				...
	    				<input type="text" id="guideName" name="guide.guideName" readonly="readonly" onclick="imp()" value="${vo.guide.guideName }" class="IptText300"></div>
					<div class="clear"></div>
	    		</dd> 
                <dd>
	    			<div class="dd_left">导游电话：</div> 
	    			<div class="dd_right">
	    			<input type="text" id="guideMobile" name="guide.guideMobile" readonly="readonly" onclick="imp()" value="${vo.guide.guideMobile }" class="IptText300"></div>
					<div class="clear"></div>
	    		</dd>
	    		<dd>
	    	...
	    	<div  id="times">
	    		<dd>
	    			...
	    			<div class="dd_right">
	    			<input type="text" readonly="readonly" name="guideTimes[${a.index}].timeStart" class="Wdate" class="IptText300" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" value="${times.timeStart }" placeholder="上团时间"/>
	    			~<input type="text" readonly="readonly" name="guideTimes[${a.index}].timeEnd" class="Wdate" class="IptText300" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" value="${times.timeEnd }" placeholder="下团时间"/>
					</div>
					<div class="clear"></div>
	    		</dd> 
	    	</div>
...
<dd>
	    			<div class="dd_left">时间：</div> 
	    			<div class="dd_right">
	    			<input type="text"  name="guideTimes[$index].timeStart" class="Wdate" class="IptText300" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="" placeholder="上团时间"/>
	    			~<input type="text"  name="guideTimes[$index1].timeEnd" class="Wdate" class="IptText300" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="" placeholder="下团时间"/>
					</div>
