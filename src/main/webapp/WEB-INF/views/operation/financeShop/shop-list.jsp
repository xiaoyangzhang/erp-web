	    ...
	    <div class="p_container_sub" id="list_search">
	    	...
	    	<dl class="p_paragraph_content">
	    		<dd class="inl-bl">
	    			...
	    			<input type="hidden" id="searchPageSize" name="pageSize"  value="${page.pageSize }"/>
						</div>
	    		...
	    		<dd class="inl-bl">
	    			...
	    			<div class="dd_right">
	    				<!-- <input type="hidden" name="guideId" id="guideId" value=""/> -->
						<input name="guideName" id="guideName" value="" type="text" /> 
	    				</div>
	    		...
	    		<dd class="inl-bl">
	    			<div class="dd_right">
	    				<button type="button" onclick="im();" class="button button-primary button-small">数据导入</button>
	    			</div>
	    			<div class="clear"></div>
	    		</dd>
            ...
            <dl class="p_paragraph_content">
	    		<dd>
    			 <div class="pl-10 pr-10" id="bookingShopDiv" >
...
function queryList(page,pageSize) {
	...
	$("#searchPage").val(page);
	var options = {
		url:"bookingShopList.do",
    	type:"post",
    	dataType:"html",
    	success:function(data){
    		$("#bookingShopDiv").html(data);
    	},
    	error:function(XMLHttpRequest, textStatus, errorThrown){
    		$.error("服务忙，请稍后再试");
    	}
    };
    $("#searchBookingShopForm").ajaxSubmit(options);	
}
...
function im(){
	newWindow('数据导入','<%=staticPath%>/bookingFinanceShop/importData.htm');
}
</script>
</body>
</html>
