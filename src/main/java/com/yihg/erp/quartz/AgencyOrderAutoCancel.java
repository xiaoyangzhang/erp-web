...
public class AgencyOrderAutoCancel {
	...
	@Autowired
	private AgencyOrderDealFacade agencyOrderDealFacade;
...
//			}
//		}
		ResultSupport resultSupport = agencyOrderDealFacade.execute();
	}
...
//			}
//		}
		ResultSupport resultSupport = agencyOrderDealFacade.executeUpdateResOrderState(orderState);
	}
