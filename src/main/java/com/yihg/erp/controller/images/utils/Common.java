...
public class Common {
	...
	/*
		...
		array.add(JSON.parse("{\"status\":\"sucess\"}"));
		...
		JSONArray array1= JSONArray.parseArray(str);
		System.out.println(array1.get(0));
		System.out.println(array1.get(1));
		LoginUserVO v= JSON.parseObject(array1.get(1).toString(), LoginUserVO.class);
		System.out.println(v.getName()+"ss"+v.getPassword());*/
		//gson
		//User userD = gson.fromJson("{name:\"D\",sex:\"man\",fav:[\"book\",\"game\"]}", User.class);  
	    //    System.out.println(userD.getName()+"  "+userD.getSex());  
		try {
			FileInputStream f=new FileInputStream(new File("C:\\Users\\del\\Pictures\\QQ图片20140610135532.jpg"));
		   	String fileUrl = UploadFileUtil.uploadFile( f,  Common.getFileExt2("aa.jpg"), null);
